  ...
  return (
    <div className="html-page" style={{ maxWidth: 1200, margin: '2rem auto', padding: '1.5rem' }}>
      <div className="flex justify-between items-center mb-6">
        <h1 className="text-3xl font-bold text-heading_color">React Questions</h1>
      ...
      {isLoading && questions.length === 0 ? (
        <div className="text-center py-12 border-2 border-base_border rounded-xl bg-card_bg">
          <p className="text-xl text-text_color">Loading React questions...</p>
        </div>
      ) : sortedQuestions.length === 0 ? (
        <div className="text-center py-12 border-2 border-base_border rounded-xl bg-card_bg">
          <p className="text-xl text-text_color mb-4">No React questions yet!</p>
